...
import com.command.toyvillage_server.domain.app.dashboard.service.DashBoardQueryAnimalManageService;
...
public class DashBoardController {
    ...
    private final DashBoardQueryAnimalManageService dashBoardQueryAnimalManageService;
    ...
    @GetMapping("/animal-observations")
    public Page<DashBoardQueryAnimalManageResponse> getAnimalObservations(
